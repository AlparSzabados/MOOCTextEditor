...
public class EfficientDocumentTest {
     ...
     */
    public static void testCase(EfficientDocument doc, int syllables, int words, int sentences) {
    ...
    public void shouldTestFleschIndex() {
        EfficientDocument text = new EfficientDocument("All children, except one, grow up. They soon know that they will grow up, and the way Wendy knew was this. " +
        ...
        double actual = 81.23;
        double expected = text.getFleschScore();
